---
title: "Install PC Caster on Windows"
sidebarTitle: "Installation"
description: "Install Python 3.9+, download PC Caster, and run run.bat to automatically install all dependencies and launch the app."
---
