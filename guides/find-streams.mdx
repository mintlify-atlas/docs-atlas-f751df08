---
title: "Capture .m3u8 Streams from Any Live Streaming Page"
sidebarTitle: "Find Streams"
description: "Use PC Caster's stream scanner to capture .m3u8 HLS URLs and their Referer headers from live stream pages using a visible Chromium browser."
---
...
The scanner raises two special internal tokens if something is missing:
