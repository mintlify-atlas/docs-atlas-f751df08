...
description: "The PC Caster Roku channel is a sideloaded BrightScript SceneGraph app controlled via Roku ECP. Plays any HLS or MP4 URL sent via ECP launch or /input."
---
